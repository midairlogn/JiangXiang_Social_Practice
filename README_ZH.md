...
媒体资源已于 2026 年 8 月完成系统审计，删除了明显无关图片、误导性的包装图、重复物理文件和失效视频引用。

每个文件的来源和版权状态见 [MEDIA_SOURCES.md](MEDIA_SOURCES.md)。任何新网络图片进入仓库前，都应先在该文件中记录来源和可复用状态。
