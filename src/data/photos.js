...
export const photos = [
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/labor/afsaf.webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/labor/OIP-C (1).webp',
  ...
  newPhoto({
    ...
    season: 'spring',
    theme: 'labor',
    src: '/media_new/labor/OIP-C (2).webp',
    alt: '劳动者在春季田块中进行播种作业'
  }),
  newPhoto({
    id: 13,
    ...
    season: 'summer',
    theme: 'labor',
    src: '/media_new/labor/OIP-C (3).webp',
  ...
  newPhoto({
    ...
    season: 'autumn',
    theme: 'labor',
    src: '/media_new/labor/OIP-C (4).webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'labor',
    src: '/media_new/labor/OIP-C (5).webp',
    alt: '多人在室内共同参与手工制作活动'
  }),
  newPhoto({
    id: 16,
    ...
    season: 'autumn',
    theme: 'labor',
    src: '/media_new/labor/OIP-C (6).webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'labor',
    src: '/media_new/labor/OIP-C (7).webp',
  ...
  newPhoto({
    ...
    season: 'spring',
    theme: 'labor',
    src: '/media_new/labor/OIP-C (8).webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'labor',
    src: '/media_new/labor/OIP-C.webp',
    alt: '劳动者操作传统织机进行手工织造'
  }),
  newPhoto({
    id: 20,
    ...
    season: 'year-round',
    theme: 'scenery',
    src: '/media_new/scenery/10030v000000k41im407D_C_300_300.jpg',
  ...
  newPhoto({
    ...
    season: 'spring',
    theme: 'scenery',
    src: '/media_new/scenery/28e15cb4021ced21213a9cdb.jpg',
    alt: '新柳掩映的乡村水面与游弋水禽'
  }),
  newPhoto({
    id: 24,
  ...
  newPhoto({
    ...
    season: 'summer',
    theme: 'scenery',
    src: '/media_new/scenery/CggYsVce1iiAdzHGAAIT55InlT8098.jpg',
  ...
  newPhoto({
    ...
    season: 'summer',
    theme: 'scenery',
    src: '/media_new/scenery/f93c1cb9c028f402.jpg_r_640x853x70_a6adfdf1.jpg',
    alt: '水面铺满荷叶的夏日乡村荷塘'
  }),
  newPhoto({
    id: 31,
  ...
  newPhoto({
    ...
    season: 'summer',
    theme: 'scenery',
    src: '/media_new/scenery/nsdfohfl.jpg',
  ...
  newPhoto({
    ...
    season: 'autumn',
    theme: 'scenery',
    src: '/media_new/scenery/OIP-C (.webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'scenery',
    src: '/media_new/scenery/OIP.webp',
    alt: '成片绿树环抱整齐村居的俯瞰景观'
  }),
  newPhoto({
    id: 35,
  ...
  newPhoto({
    ...
    season: 'spring',
    theme: 'scenery',
    src: '/media_new/scenery/t01cde8a7523775c3bb.jpg',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'scenery',
    src: '/media_new/scenery/W020230530572632448315.jpg',
  ...
  newPhoto({
    ...
    season: 'summer',
    theme: 'scenery',
    src: '/media_new/scenery/scenery-reference.jpg',
  ...
  newPhoto({
    ...
    season: 'summer',
    theme: 'life',
    src: '/media_new/village-life/6cf9d79655b386f7.jpg_r_720x480x95_0e014a6b.jpg',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/awfag.webp',
  ...
  newPhoto({
    ...
    season: 'summer',
    theme: 'life',
    src: '/media_new/village-life/ddddd.webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/de.webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/kklj.webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/OIP-C (1).webp',
    alt: '社区工作人员与多位老人围坐交流'
  }),
  newPhoto({
    id: 45,
    ...
    season: 'summer',
    theme: 'scenery',
    src: '/media_new/village-life/OIP-C (2).webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/OIP-C (3).webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/OIP-C (4).webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/OIP-C (5).webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/OIP-C (6).webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/OIP-C.webp',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/sd.jpg',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/Xx1IbI.jpg',
  ...
  newPhoto({
    ...
    season: 'year-round',
    theme: 'life',
    src: '/media_new/village-life/yuytoii.webp',
  ...
  newPhoto({
    ...
    season: 'winter',
    theme: 'life',
    src: '/media_new/winter/OIP (2).webp',
    alt: '身着冬装的人们围桌举杯相聚'
  }),
  newPhoto({
    id: 56,
    ...
    season: 'winter',
    theme: 'life',
    src: '/media_new/winter/OIP (3).webp',
