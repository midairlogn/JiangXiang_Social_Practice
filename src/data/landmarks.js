...
export const landmarkCategories = [
  { value: 'all', label: '全部' },
  { value: 'nature', label: '自然生态', color: '#2f7d4a', shape: 'circle', shapePath: 'circle(48% at 50% 50%)' },
  { value: 'culture', label: '文化历史', color: '#b88916', shape: 'diamond', shapePath: 'polygon(50% 0, 100% 50%, 50% 100%, 0 50%)' },
  { value: 'agriculture', label: '农业观光', color: '#8a5a34', shape: 'triangle', shapePath: 'polygon(50% 0, 100% 100%, 0 100%)' },
  { value: 'residential', label: '居住社区', color: '#3b6ea8', shape: 'square', shapePath: 'inset(4% 4% 4% 4%)' },
  { value: 'industry', label: '工业园区', color: '#5f6570', shape: 'hexagon', shapePath: 'polygon(25% 4%, 75% 4%, 100% 50%, 75% 96%, 25% 96%, 0 50%)' },
  { value: 'entertainment', label: '休闲娱乐', color: '#b64e7a', shape: 'star', shapePath: 'polygon(50% 0, 61% 35%, 98% 35%, 68% 57%, 79% 94%, 50% 72%, 21% 94%, 32% 57%, 2% 35%, 39% 35%)' },
  { value: 'accommodation', label: '住宿度假', color: '#7857a6', shape: 'rounded-square', shapePath: 'inset(3% round 28%)' },
  { value: 'welfare', label: '民生福利', color: '#d06a2e', shape: 'cross', shapePath: 'polygon(34% 0, 66% 0, 66% 34%, 100% 34%, 100% 66%, 66% 66%, 66% 100%, 34% 100%, 34% 66%, 0 66%, 0 34%, 34% 34%)' }
]
